    ...
    <div className="min-h-screen bg-black text-white px-4 py-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold">Screens</h1>

            <p className="text-white/50 mt-2">Manage your theatre screens</p>
          </div>
        </div>
        ...
        {screens.length === 0 ? (
          ...
          >
            ...
            <p className="text-white/50 mt-2">Create your first screen</p>
          </div>
        ) : (
          <div
            className="
            ...
            {screens.map((screen) => (
              ...
              >
                ...
                <div className="mt-6 flex flex-col gap-3">
                  <Link
                    to={`/theatre-owner/shows/create/${screen._id}`}
                    className="
                        w-full
